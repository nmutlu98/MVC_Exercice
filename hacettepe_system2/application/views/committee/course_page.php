                            ...
                            <div class="tm-img-gallery-container">
                                ...
                                <!-- Gallery One pop up connected with JS code below -->                                    
                                    <div class="tm-img-gallery-info-container">                                    
                                        <h2 class="tm-text-title tm-gallery-title tm-white"><span class="tm-white"><?php echo $commitee ?></span></h2>
                                    </div>
                                    <?php 
                                        ...
                                        foreach($courses as $course){ ?>
                                            <div class="grid-item">
                                                <figure class="effect-bubba">
                                                    ...
                                                    <img src="http://localhost/hacettepe_system2/application/views/committee/img/folder.png" alt="Image" class="img-fluid tm-img">
                                                    <figcaption>
                                                        <h4 class="tm-figure-title"> <span><strong><?php echo $course[0] ?></strong></span></h4>
                                                        
                                                        <a href="<?php echo site_url('course/course_page/'.$commitee_id."/".$course[1]) ?>"></a>
                                                    </figcaption>           
                                                </figure>
