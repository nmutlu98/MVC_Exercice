...
<head>
    ...
    <title><?php echo $commitee_name."-".$title ?></title>
<!--
                            ...
                            <div class="tm-img-gallery-container">
                                ...
                                <!-- Gallery One pop up connected with JS code below -->                                    
                                    <div class="tm-img-gallery-info-container">                                    
                                        <h2 class="tm-text-title tm-gallery-title tm-white"><span class="tm-white"></span><?php echo $commitee_name."-".$title ?></h2>
                                    </div>
                                    <?php 
                                        ...
                                        foreach($documents as $doc){ ?>
                                            <div class="grid-item">
                                                <figure class="effect-bubba">
                                                    ...
                                                    <img src="http://localhost/hacettepe_system2/application/views/document/img/file.png" alt="Image" class="img-fluid tm-img">
                                                    <figcaption>
                                                        <h4 class="tm-figure-title" style="color:   #000000"> <span><strong><?php echo $doc['document_name'] ?></strong></span></h4>
                                                        <p class="tm-figure-description"></p>
                                                        <a href="<?php echo $doc['document_link'] ?>"></a>
                                                    </figcaption>           
                                                </figure>
