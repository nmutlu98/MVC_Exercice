  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Yetkili Kişi Bilgileri <small>
          ...
          <div class="x_content">
            ...
            <form action="<?php echo site_url('operation/save_authorized_person') ?>" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
