  <!-- footer content -->
    ...
    <!-- jQuery -->
    <script src="http://localhost/hacettepe_system2/application/views/admin_main/pages_vendors/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap -->
    <script src="http://localhost/hacettepe_system2/application/views/admin_main/pages_vendors/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- FastClick -->
